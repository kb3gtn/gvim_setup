...
" Assume we are using a fast TTY
set ttyfast

" Also set not backward compatable
set nocompatible
...
set gfn=Roboto\ Mono\ Medium\ for\ Powerline\ Medium\ 11

"Turn fancy tabline one for text mode interface
let g:airline#extensions#tabline#enabled = 1

"Allow use of fancy powerline patched font symbols
